import {
  ...
  strlen,
  token
} from "./chunk-DPSQQXUT.js";
import {
  _extends,
  _objectWithoutPropertiesLoose,
  init_extends
} from "./chunk-5P3PZHSN.js";
import {
  require_jsx_runtime
...
function mergeChildMappings(prev, next2) {
  prev = prev || {};
  next2 = next2 || {};
  function getValueForKey(key) {
    return key in next2 ? next2[key] : prev[key];
  }
...
function createBox(options = {}) {
  ...
  const Box2 = React27.forwardRef(function Box3(inProps, ref) {
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-EQW7PDW5.js.map
